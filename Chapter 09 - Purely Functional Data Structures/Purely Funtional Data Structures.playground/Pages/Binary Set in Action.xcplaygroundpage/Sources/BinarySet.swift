...
extension BinarySet: SetLike {
    ...
    //: Recursively reads the tree to determine if an element is contained within
    ...
    //: Recursively gathers all of the elements in the tree, results will always be sorted
